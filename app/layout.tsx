...
export const metadata: Metadata = {
  ...
  description: 'Enterprise policy management with AI-powered generation and compliance checking',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Build error detector - runs before React */}
        <Script src="/build-error-detector.js" strategy="beforeInteractive" />
      </head>
